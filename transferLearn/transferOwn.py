...
print()
print()
print(cls_pred[60:69])
print("    TRANSFER LEARNING USING INCEPTION MODEL")
for i in range(0, 140):
	# if(i%20 == 0 and val != 0):
	# 	print("    Number of ", int(i/20) - 1, "correctly predicted = ", val, "/20")
	# 	ans = ans + val
	# 	val = 0
	if(cls_pred[i] == cls_test[i]):
		val = val + 1
# print("    Number of ", int(i/20) , "correctly predicted = ", val, "/20")
ans = ans + val
print("    Accuracy obtained using tranfer learning = ", ans/140*100, "%")
print()
print()
print()
